...
// propValue = livre[propName];
// if (propName === 'id') {
//   idLivre = `<h3>id</h3>${livre.propName}`;
//   console.log(idLivre);
//   injection += idLivre;
// }
// }
...
function render() {
  ...
  for (var livre of bds) {
    ...
    Serie: ${livre.serie}<br>
    Type: ${livre.type}<br>
    Etat: ${livre.etat}<br>

    ISBN: ${livre.isbn}<br>
    Année: ${livre.annee_de_parution}<br>
    Etat: ${livre.no_tome}<br>
    Prix: ${livre.prix}<br>
    Like: ${livre.like}<br>
